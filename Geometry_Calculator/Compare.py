...
class compare_shapes:
    ...
    def Triangle(self): 
        # Triangle class to calculate area and perimeter
    ...
    def compare_shapes_func(self):
            ...
            # Print both area and perimeter comparisons
    ...
    def Sort_shapes(self):
            ...
            if sort_by == "1":
                ...
                print(f"The shapes sorted by area: {self.shapes}")
            elif sort_by == "2":
                self.shapes.sort(key=lambda x: x[1])
                print(f"The shapes sorted by perimeter: {self.shapes}")
            else:
                print("\nThat is not an option.")
                self.Sort_shapes()
